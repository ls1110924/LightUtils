package com.yunxian.lightutils.lib.bean;

import com.yunxian.lightutils.lib.enumeration.NetOperation;
import com.yunxian.lightutils.lib.net.message.BasicNameValuePair;
import com.yunxian.lightutils.lib.net.message.NameValuePair;
 ...
 * 由{@link com.yunxian.lightutils.lib.net.NetFactory#getNetResult(ApiRequestBean)}方法访问网络时，所需的URL内容
 */
