package com.yunxian.lightutils.lib.compat;
 ...
 * <p>此处为了覆写{@link #isEmpty()}方法的处理逻辑</p>
 */
public final class RectCompat implements Parcelable {
     ...
     */
    public RectCompat(int left, int top, int right, int bottom) {
        this.left = left;
        this.top = top;
        this.right = right;
        this.bottom = bottom;
    ...
    /**
     * Returns true if the rectangle is empty (left == 0 && right == 0 && top == 0 && bottom == 0)
     */
